...
class Contract PROTOBUF_FINAL :
 ...
 public:
  ...
  void set_lasttradedate(const std::string& value);
  void set_lasttradedate(std::string&& value);
  void set_lasttradedate(const char* value);
  void set_lasttradedate(const char* value, size_t size);
  std::string* mutable_lasttradedate();
  std::string* release_lasttradedate();
  void set_allocated_lasttradedate(std::string* lasttradedate);
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  std::string* unsafe_arena_release_lasttradedate();
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  void unsafe_arena_set_allocated_lasttradedate(
      std::string* lasttradedate);
  private:
  const std::string& _internal_lasttradedate() const;
  void _internal_set_lasttradedate(const std::string& value);
...
inline void Contract::clear_lasttradedate() {
  lasttradedate_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
...
inline void Contract::set_lasttradedate(const std::string& value) {
  _internal_set_lasttradedate(value);
...
inline std::string* Contract::mutable_lasttradedate() {
  ...
  return _internal_mutable_lasttradedate();
}
...
inline void Contract::_internal_set_lasttradedate(const std::string& value) {
  _has_bits_[0] |= 0x00004000u;
  lasttradedate_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void Contract::set_lasttradedate(std::string&& value) {
  _has_bits_[0] |= 0x00004000u;
  lasttradedate_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:protobuf.Contract.lastTradeDate)
}
inline void Contract::set_lasttradedate(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00004000u;
  lasttradedate_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:protobuf.Contract.lastTradeDate)
}
inline void Contract::set_lasttradedate(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00004000u;
  lasttradedate_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:protobuf.Contract.lastTradeDate)
}
inline std::string* Contract::_internal_mutable_lasttradedate() {
  _has_bits_[0] |= 0x00004000u;
  return lasttradedate_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* Contract::release_lasttradedate() {
  ...
  _has_bits_[0] &= ~0x00004000u;
  return lasttradedate_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
...
inline std::string* Contract::unsafe_arena_release_lasttradedate() {
  // @@protoc_insertion_point(field_unsafe_arena_release:protobuf.Contract.lastTradeDate)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00004000u;
  return lasttradedate_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void Contract::unsafe_arena_set_allocated_lasttradedate(
    std::string* lasttradedate) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (lasttradedate != nullptr) {
    _has_bits_[0] |= 0x00004000u;
  ...
  lasttradedate_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      lasttradedate, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:protobuf.Contract.lastTradeDate)
}
