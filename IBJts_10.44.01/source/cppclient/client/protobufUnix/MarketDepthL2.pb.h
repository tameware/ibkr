...
class MarketDepthL2 PROTOBUF_FINAL :
 ...
 public:
  ...
  inline MarketDepthL2* New() const final {
    return CreateMaybeMessage<MarketDepthL2>(nullptr);
  }

  MarketDepthL2* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_MarketDepthL2_2eproto);
    return ::descriptor_table_MarketDepthL2_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
inline ::PROTOBUF_NAMESPACE_ID::int32 MarketDepthL2::_internal_reqid() const {
  return reqid_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 MarketDepthL2::reqid() const {
  // @@protoc_insertion_point(field_get:protobuf.MarketDepthL2.reqId)
  return _internal_reqid();
}
inline void MarketDepthL2::_internal_set_reqid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x00000002u;
  reqid_ = value;
}
inline void MarketDepthL2::set_reqid(::PROTOBUF_NAMESPACE_ID::int32 value) {
