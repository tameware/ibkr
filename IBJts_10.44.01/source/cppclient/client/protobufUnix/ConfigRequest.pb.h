...
class ConfigRequest PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_ConfigRequest_2eproto);
    return ::descriptor_table_ConfigRequest_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
inline ::PROTOBUF_NAMESPACE_ID::int32 ConfigRequest::_internal_reqid() const {
  return reqid_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 ConfigRequest::reqid() const {
  // @@protoc_insertion_point(field_get:protobuf.ConfigRequest.reqId)
  return _internal_reqid();
}
inline void ConfigRequest::_internal_set_reqid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x00000001u;
  reqid_ = value;
}
inline void ConfigRequest::set_reqid(::PROTOBUF_NAMESPACE_ID::int32 value) {
