...
class Order PROTOBUF_FINAL :
 ...
 public:
  ...
  // int32 routeMarketableToBbo = 120;
  bool has_routemarketabletobbo() const;
  private:
  bool _internal_has_routemarketabletobbo() const;
  public:
  void clear_routemarketabletobbo();
  ::PROTOBUF_NAMESPACE_ID::int32 routemarketabletobbo() const;
  void set_routemarketabletobbo(::PROTOBUF_NAMESPACE_ID::int32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_routemarketabletobbo() const;
  void _internal_set_routemarketabletobbo(::PROTOBUF_NAMESPACE_ID::int32 value);
  public:
  ...
  // int32 seekPriceImprovement = 142;
  bool has_seekpriceimprovement() const;
  private:
  bool _internal_has_seekpriceimprovement() const;
  public:
  void clear_seekpriceimprovement();
  ::PROTOBUF_NAMESPACE_ID::int32 seekpriceimprovement() const;
  void set_seekpriceimprovement(::PROTOBUF_NAMESPACE_ID::int32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_seekpriceimprovement() const;
  void _internal_set_seekpriceimprovement(::PROTOBUF_NAMESPACE_ID::int32 value);
  public:

  // int32 whatIfType = 143;
  bool has_whatiftype() const;
  private:
  bool _internal_has_whatiftype() const;
  public:
  void clear_whatiftype();
  ::PROTOBUF_NAMESPACE_ID::int32 whatiftype() const;
  void set_whatiftype(::PROTOBUF_NAMESPACE_ID::int32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_whatiftype() const;
  void _internal_set_whatiftype(::PROTOBUF_NAMESPACE_ID::int32 value);
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 routemarketabletobbo_;
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 seekpriceimprovement_;
  ::PROTOBUF_NAMESPACE_ID::int32 whatiftype_;
...
inline ::PROTOBUF_NAMESPACE_ID::int32 Order::_internal_routemarketabletobbo() const {
  return routemarketabletobbo_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 Order::routemarketabletobbo() const {
  // @@protoc_insertion_point(field_get:protobuf.Order.routeMarketableToBbo)
  return _internal_routemarketabletobbo();
}
inline void Order::_internal_set_routemarketabletobbo(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[3] |= 0x01000000u;
  routemarketabletobbo_ = value;
}
inline void Order::set_routemarketabletobbo(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int32 Order::_internal_seekpriceimprovement() const {
  return seekpriceimprovement_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 Order::seekpriceimprovement() const {
  // @@protoc_insertion_point(field_get:protobuf.Order.seekPriceImprovement)
  return _internal_seekpriceimprovement();
}
inline void Order::_internal_set_seekpriceimprovement(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[4] |= 0x00000200u;
  seekpriceimprovement_ = value;
}
inline void Order::set_seekpriceimprovement(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int32 Order::_internal_whatiftype() const {
  return whatiftype_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 Order::whatiftype() const {
  // @@protoc_insertion_point(field_get:protobuf.Order.whatIfType)
  return _internal_whatiftype();
}
inline void Order::_internal_set_whatiftype(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[4] |= 0x00000400u;
  whatiftype_ = value;
}
inline void Order::set_whatiftype(::PROTOBUF_NAMESPACE_ID::int32 value) {
