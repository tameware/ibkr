...
static void InitDefaultsscc_info_UserInfo_UserInfo_2eproto() {
  ...
  {
    void* ptr = &::protobuf::_UserInfo_default_instance_;
    new (ptr) ::protobuf::UserInfo();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::protobuf::UserInfo::InitAsDefaultInstance();
}
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_UserInfo_2eproto_sccs[1] = {
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_UserInfo_2eproto = {
  false, false, descriptor_table_protodef_UserInfo_2eproto, "UserInfo.proto", 184,
  &descriptor_table_UserInfo_2eproto_once, descriptor_table_UserInfo_2eproto_sccs, descriptor_table_UserInfo_2eproto_deps, 1, 0,
  schemas, file_default_instances, TableStruct_UserInfo_2eproto::offsets,
  file_level_metadata_UserInfo_2eproto, 1, file_level_enum_descriptors_UserInfo_2eproto, file_level_service_descriptors_UserInfo_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_UserInfo_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_UserInfo_2eproto)), true);
namespace protobuf {
...
UserInfo::UserInfo(const UserInfo& from)
  ...
  if (from._internal_has_whitebrandingid()) {
    whitebrandingid_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_whitebrandingid(),
      GetArena());
  }
  reqid_ = from.reqid_;
...
void UserInfo::InternalSwap(UserInfo* other) {
  ...
  whitebrandingid_.Swap(&other->whitebrandingid_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
