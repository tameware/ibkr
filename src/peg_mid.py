...
class Trader(EWrapper, EClient):
    def __init__(self, config: Dict[str, Any]):
        ...
        self.logger = build_logger(
            config, logger_name="peg_mid", default_log_file="peg_mid.log"
        )
        ...
        self.client_id = ib_client_id_from_config(config, default=3)
        self.ledger = PositionLedger.open("peg_mid", config, client_id=self.client_id)
